...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  //1) Get user based on posted email then
  ...
  try {
    ...
    await user.save({ validateBeforSave: false }); //will disable all the validator for saving
    return next(
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  }); //this will find the user who has token that was send by the url
